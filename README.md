...
The `Knight_Item_Positions` class is the building block of the board; is used by Knight, Item and Arena to determine their position.
...
- A `Knight_Item_Positions` instance always knows whether it holds _items_ or a _knight_.
...
## Knight class:
    ...
    ID: R
    Knight_Item_Positions: <Knight_Item_Positions>
    equipped: <Item>
    BaseAttack: 1
    BaseDefence: 1
...
**Properties**
    ...
    board - 2 dimensional matrix
            each item is a Knight_Item_Positions element
